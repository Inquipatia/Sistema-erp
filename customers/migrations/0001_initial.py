    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_customer', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='Customer ID')),
                ...
                ('currency', models.CharField(blank=True, max_length=20, verbose_name='Currency')),
